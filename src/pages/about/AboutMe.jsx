    ...
    <>
      {show ? (
        <TypeAnimation
          ...
          speed={50}
          repeat={Infinity}
          className="text-sm md:text-xl xl:text-2xl transition-all ease-linear duration-300 text-readable"
        />
      ) : (
      ...
      <div className="mt-4">
        <p className="text-justify text-xs xl:text-base text-readable-light font-light">
          I'm a Bachelor of Science in Information Technology Graduate at
          University of Cebu Lapu-Lapu and Mandaue (UCLM).
        </p>

        <p className="text-justify text-xs xl:text-base mt-3 text-readable-light font-light">
