      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm">Web 3D</span>
            <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm">Web AR</span>
            <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm">Web VR</span>
            ...
            <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm">Database Management</span>
            <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm">System Integration</span>
            <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-sm">Performance Optimization</span>
